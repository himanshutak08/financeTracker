...
HACS releases should use semantic version tags such as `v0.2.4`. The tag version must match `custom_components/finance_tracker/manifest.json`, and each GitHub release should summarize migrations and user-visible changes.
